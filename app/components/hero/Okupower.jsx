    ...
    return ( 
        ...
        <section className="h-full w-full sm:w-[40rem] flex flex-col justify-center ">
          <h1 className="text-4xl capitalize mt-3 w-[22rem] sm:w-[25rem] leading-[3rem]">
            ...
            <Image src="https://res.cloudinary.com/dszhzezvt/image/upload/v1683566537/amihub/okupower_png_1_ufw7yd.png" alt="Logo" width={130} height={98} priority />  <div className=" text-base ">incubated by AMIHUB</div>
          </h1>
          <p className="mt-6">
        ...
        <section className=" w-full sm:w-[50rem] flex items-center justify-center">
            ...
            alt="Girl"
            className="relative z-30 inline object-contain h-full w-full"
            width={1000}
            height={100}
            priority
          />
